...
class Index
    ...
    Index&
    noprime() { prime(-primelevel_); return *this; }
...
class IndexVal
    ...
    IndexVal& 
    mapprime(int plevold, int plevnew)
        { index.mapprime(plevold,plevnew); return *this; }
...
Index inline
mapprime(Index I, int plevold, int plevnew)
    { I.mapprime(plevold,plevnew); return I; }
...
IndexVal inline
mapprime(IndexVal I, int plevold, int plevnew)
    { I.mapprime(plevold,plevnew); return I; }
